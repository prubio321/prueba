...
<div class="container">
    ...
    <form:form action="/citaMedica/actualizar/${citaMedica.id}" method="post" modelAttribute="citaMedica">
        ...
        <button type="submit" class="btn btn-outline-warning">Editar Cita Medica</button>
    </form:form>
</div>
</body>
</html>