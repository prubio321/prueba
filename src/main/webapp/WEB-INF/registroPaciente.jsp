...
<div class="container">
    ...
    <form:form action="/paciente/registro/${paciente.id}" method="post" modelAttribute="paciente">
        ...
        <button type="submit" class="btn btn-outline-primary">Guardar paciente</button>
    </form:form>
</div>
</body>
</html>